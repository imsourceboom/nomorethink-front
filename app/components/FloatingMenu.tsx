...
export default function FloatingMenu({ onMenuClick }: FloatingMenuProps) {
    ...
    const calculatePosition = (index: number, total: number, radius: number = 100) => {
        ...
        <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50">
            ...
            <div className={`absolute transition-all duration-300 ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-0 pointer-events-none'}`}>
                ...
                <button 
                    ...
                    className="absolute w-12 h-12 bg-blue-500 rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform"
                    style={{ 
                ...
                <button 
                    ...
                    className="absolute w-12 h-12 bg-green-500 rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform"
                    style={{ 
                ...
                <button 
                    ...
                    className="absolute w-12 h-12 bg-purple-500 rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform"
                    style={{ 
