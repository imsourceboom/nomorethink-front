...
export default function FloatingMenu({ onMenuClick }: FloatingMenuProps) {
    ...
    return (
        <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50">
            <button
                onClick={handleClick}
                className="w-12 h-12 bg-blue-600 rounded-full shadow-lg flex items-center justify-center transition-transform duration-300 hover:scale-110 hover:bg-blue-700"
                aria-label="메뉴 열기"
            >
