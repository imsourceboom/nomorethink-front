...
const CoinIcon = ({ symbol }: { symbol: string }) => {
    ...
    return <div className={iconClass}>{symbol.substring(0, 1)}</div>;
};
...
export default function Home() {
    ...
    return (
        <AppPageLayout>
            <div className="w-full min-h-full bg-[#202124] text-white">
                {/* 메인 콘텐츠 */}
                <div className="max-w-md mx-auto pb-24">
                    ...
                    <div className="space-y-4">
                        {coins.map((coin) => (
                            <div
                                key={coin.symbol}
                                className="bg-[#292A2D] rounded-[20px] p-6 border border-[#3C4043]"
                            >
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span>
                                            {coin.purchaseValue.toLocaleString()}{' '}
                                            KRW
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
